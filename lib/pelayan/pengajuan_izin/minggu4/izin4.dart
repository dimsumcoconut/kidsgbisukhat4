...
class Izin4 extends StatefulWidget {
  const Izin4({super.key});

  @override
  State<Izin4> createState() => _Izin4State();
}

class _Izin4State extends State<Izin4> {
  ...
  void addPengajuan() async {
    if (_formKey.currentState!.validate()) {
      try {
        await MyFirebase.izin4Collection.add({
