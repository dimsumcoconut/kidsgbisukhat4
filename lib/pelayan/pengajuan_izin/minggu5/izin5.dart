...
class Izin5 extends StatefulWidget {
  const Izin5({super.key});

  @override
  State<Izin5> createState() => _Izin5State();
}

class _Izin5State extends State<Izin5> {
  ...
  void addPengajuan() async {
    if (_formKey.currentState!.validate()) {
      try {
        await MyFirebase.izin5Collection.add({
