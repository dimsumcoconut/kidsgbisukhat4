...
class DPI1 extends StatefulWidget {
  const DPI1({super.key});

  @override
  State<DPI1> createState() => _DPI1State();
}

class _DPI1State extends State<DPI1> {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => const IzinMinggu1()),
          );
        },
