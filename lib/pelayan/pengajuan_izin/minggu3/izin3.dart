...
class Izin3 extends StatefulWidget {
  const Izin3({super.key});

  @override
  State<Izin3> createState() => _Izin3State();
}

class _Izin3State extends State<Izin3> {
  ...
  void addPengajuan() async {
    if (_formKey.currentState!.validate()) {
      try {
        await MyFirebase.izin3Collection.add({
